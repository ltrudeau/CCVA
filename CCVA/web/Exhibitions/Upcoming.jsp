<%-- 
    Document   : Upcoming
    Created on : Mar 15, 2017, 11:03:03 AM
    Author     : cboyd04
--%>
...
<html>
    <head>
        ...
        <title>CCVA Upcoming Exhibitions</title>
    </head>
    <body>
        <jsp:include page="../Header.jsp"/>
        <div class="page-header col-lg-12 col-md-12 col-sm-12 row" >
            <h1 style="padding-left: 25px;">Upcoming Exhibitions </h1>
        </div>
        <div class="container">
	 <div id="blog" class="row">                 
                  
                 <div class="col-md-10 blogShort">
                     <h2>Awesome Sculpture Exhibit</h2>
                  ...
                  <div class="col-md-10 blogShort">
                     <h2>Postmodern Paintings of Garbage</h2>
                  ...
                  <div class="col-md-10 blogShort">
                     <h2>Come see drawings that dogs made</h2>
