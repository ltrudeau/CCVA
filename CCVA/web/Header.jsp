        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="../Exhibitions/Current.jsp">Current Exhibitions</a></li>
                        <li><a href="../Exhibitions/Upcoming.jsp">Upcoming Exhibitions</a></li>                        
                        <li><a href="../Exhibitions/Past.jsp">Past Exhibitions</a></li>                        
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Programs<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../Programs/Overview.jsp">Overview</a></li>                                                
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Collections<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../Collections/Overview.jsp">Overview</a></li>
                        <li><a href="../Collections/Permanent.jsp">Permanent Collection</a></li>                        
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Join and Support<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../JoinSupport/Patrons.jsp">Overview</a></li>                                                
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">About<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../About/Mission.jsp">Mission</a></li>                                                
                    </ul>
                </li>                
            </ul>
        </div><!-- /.navbar-collapse -->
